            ...
            <div className="card-body w-[380px] h-[100px]">
                <div className="flex my-1">
                    ...
                    <div className=" absolute right-10">
                        <h1 className="font-medium">Travel Time: <span className="text-green-800 font-semibold">{travel_time}</span></h1>
                    </div>
                </div>
                ...
                <h1 className="font-medium">Location: <span className="text-sky-600">{location}, {country_name}</span> </h1>
                </div>
                ...
                <div className="my-1">
                    ...
                    <h1 className="font-medium">Travelers per Year: <span className="text-green-700">{total_visitors_per_year}</span></h1> 
                    </div>
                </div>
            </div>
