            ...
            <div className="navbar bg-base-100 w-[1210px]">
                ...
                <div className="navbar-end">
                    {user ?
                        ...
                        <>
                            <NavLink to="/login" className="btn mr-3 w-[120px] h-[48px] bg-[#23BE0A] hover:bg-[#23BE0A] text-[#FFFFFF]">Log In</NavLink>
                            <NavLink to="/register" className="btn w-[120px] h-[48px] bg-[#59C6D2] hover:bg-[#59C6D2] text-[#FFFFFF]">Register</NavLink>
                        </>}
                </div>
                <div className="ml-3">
